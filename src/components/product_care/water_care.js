...
function WaterCare(){
    return (
        <div className="water-care " id="water-care">
            <div className="row water-container">
                <div className="guide-text col s12 m4 offset-m1 offset-l2 l3">
                    ...
                    <p>It is always better to revive a plant that has too little water than to overwater. <strong>Plants with leaves that pucker aren’t getting enough water; the ones with soggy leaves are getting too much water.</strong></p>
